...
<title>ResQRoutes | Vehicle Details</title>
<!--Bootstrap -->
        ...
        <div class="sidebar_widget">
          ...
          <form method="post">
            <div class="form-group">
              <input type="time" class="form-control" name="fromdate" placeholder="From Date(dd/mm/yyyy)" required>
            </div>
            <div class="form-group">
